...
public:
     ...
     */
    void addObserver(const std::shared_ptr<core::Observer> observer) { observers_.push_back(observer); }
...
public:
    // constructor
    MoveableSubject(Coordinate pos, core::Direction dir, int world_width, int world_height)
     ...
     */
    virtual void update(float dt, core::World& world) = 0;
